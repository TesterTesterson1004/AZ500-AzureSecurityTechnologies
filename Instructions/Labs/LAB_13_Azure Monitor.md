...
1. Ensure that **Windows Event Logs** is selected, click **+ Add windows event log** and in the search box type and then select **System**.
...
1. Click **Windows Performance Counters**, and then **+ Add performance counter** and pick several from the list.
